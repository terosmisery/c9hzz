...
-- Small square launcher. The main window starts closed.
...
launcher.Parent = gui
corner(launcher, 8)
stroke(launcher, BORDER, 1)

local launcherMark = label(launcher, "Z", 20, PURPLE, Enum.Font.GothamBold)
launcherMark.Size = UDim2.fromScale(1, 1)
launcherMark.TextXAlignment = Enum.TextXAlignment.Center
...
path = Path("/mnt/data/ZenithV2_Terminal_UI.lua")
